import { c as createLucideIcon, b as commonjsGlobal, r as reactExports, j as jsxRuntimeExports, d as useParams, B as Button, L as Link, S as Separator, u as ue } from "./index-D83KEM3y.js";
import { B as Badge, a as CircleCheck, C as Clock } from "./useOpenAI-CqVUYGBc.js";
import { g as getLessonById, b as getLessonIndex, u as useProgress, c as useMarkComplete, d as usePostTweet, S as Skeleton, T as TriangleAlert, Q as QAPanel, L as LESSONS } from "./useProgress-CkumXAEy.js";
import { u as useTokenStatus } from "./useXToken-J_KeREXK.js";
import { T as Twitter } from "./twitter-BhU0zLNI.js";
import "./backend-CMYt4sAY.js";
/**
...
(function(module, exports$1) {
  (function(global, factory) {
    factory(exports$1, reactExports, requirePropTypes(), requireKatex());
  })(commonjsGlobal, function(exports$12, _react, _propTypes, _katex) {
...
function MathBlock({ latex }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-4 overflow-x-auto py-2 math-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    reactKatexExports.BlockMath,
    {
      math: latex,
      errorColor: "oklch(var(--destructive))",
      renderError: (error) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-destructive text-sm font-mono", children: [
        "Error: ",
        error.message
      ] })
    }
...
function InlineParts({ parts }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: parts.map(
    (part) => part.kind === "math" ? /* @__PURE__ */ jsxRuntimeExports.jsx(MathInline, { latex: part.latex }, `math-${part.latex}`) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: part.text }, `text-${part.text}`)
  ) });
}
function ContentBlock({ block }) {
  if (block.type === "paragraph") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-body leading-relaxed text-base mb-4", children: block.text });
  }
  if (block.type === "math-block") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(MathBlock, { latex: block.latex });
  }
  if (block.type === "math-inline-paragraph") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-body leading-relaxed text-base mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(InlineParts, { parts: block.parts }) });
  }
  if (block.type === "definition") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-5 rounded-lg border-l-4 border-primary bg-primary/5 px-5 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-primary uppercase tracking-wider mb-1", children: "Definition" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground mb-2", children: block.term }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-body leading-relaxed text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(InlineParts, { parts: block.body }) })
    ] });
  }
  if (block.type === "example") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-5 rounded-lg border-l-4 border-accent bg-accent/5 px-5 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-accent-foreground uppercase tracking-wider mb-2", children: "Example" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-body leading-relaxed text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(InlineParts, { parts: block.body }) })
    ] });
  }
  return null;
...
function LessonDetailPage() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-semibold text-foreground mb-2", children: "Lesson not found" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body mb-6", children: "The module you're looking for doesn't exist or may have moved." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", "data-ocid": "lesson_detail.back_button", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", children: [
  ...
  const isXConnected = (tokenStatus == null ? void 0 : tokenStatus.hasToken) && !(tokenStatus == null ? void 0 : tokenStatus.isExpired);
  ...
  async function handleMarkComplete() {
    try {
      ...
      ue.success(`"${lesson.title}" marked as complete!`);
      if (isXConnected) {
        ...
        if (result.success) {
          ue.success("Achievement shared on X!", {
            description: "Your progress has been posted."
          });
        } else {
          ue.warning("Lesson complete, but tweet failed.", {
            description: result.message
          });
        }
      }
    } catch {
      ue.error("Failed to mark lesson as complete. Please try again.");
    }
  }
  const isMutating = markCompleteMutation.isPending || postTweetMutation.isPending;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-[calc(100vh-4rem)] bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-8 max-w-2xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mb-3", children: [
        ...
        progressLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          Skeleton,
          {
            className: "h-5 w-28 rounded-full",
            "data-ocid": "lesson_detail.loading_state"
          }
        ) : isCompleted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-primary/10 text-primary border border-primary/20 font-body text-xs gap-1.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl sm:text-4xl font-semibold text-foreground leading-tight mb-2", children: lesson.title }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-sm leading-relaxed mt-3 max-w-lg", children: lesson.description })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "article",
      {
        ...
        children: [
          lesson.sections.map((section) => /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-semibold text-foreground mb-4 pb-2 border-b border-border", children: section.heading }),
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-base font-semibold text-foreground mb-0.5", children: isCompleted ? "Module complete!" : "Done with this module?" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body", children: isCompleted ? "You've already completed this module." : isXConnected ? "Mark it complete and share your progress on X." : "Mark it complete to track your progress." }),
                  markCompleteMutation.isError && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                ...
                !isCompleted && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: isMutating ? postTweetMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Twitter, { className: "w-4 h-4 animate-pulse" }),
                      "Posting to X…"
                ...
                isCompleted && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-primary/10 text-primary border border-primary/20 font-body gap-1.5 px-3 py-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(QAPanel, { lessonId, lessonName: lesson.title }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-8 gap-4", children: [
              ...
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Link,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "w-4 h-4" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline truncate max-w-[12rem]", children: prevLesson.title }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "Previous" })
                    ]
                  }
                )
              }
              ...
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Link,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline truncate max-w-[12rem]", children: nextLesson.title }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "Next" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "w-4 h-4 rotate-180" })
                    ]
                  }
                )
              }
