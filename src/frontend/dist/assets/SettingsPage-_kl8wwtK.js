import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, r as reactExports, P as Primitive, S as Separator, f as useAuth, B as Button, u as ue } from "./index-DH3rmEI7.js";
import { A as AlertDialog, a as AlertDialogTrigger, b as AlertDialogContent, c as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction } from "./alert-dialog-IuByRAIG.js";
import { B as Badge, C as Clock, a as CircleCheck } from "./badge-DGnO5i0V.js";
import { a as useClientId, b as useSetClientId, u as useTokenStatus, c as useDisconnectX } from "./useXToken-CaAvJbUv.js";
import { T as Twitter } from "./twitter-AeMJPTJp.js";
import { C as CircleAlert } from "./circle-alert-Ct5SLMGM.js";
...
function ClientIdField() {
  ...
  const handleSave = () => {
    const trimmed = (value || savedClientId || "").trim();
    if (!trimmed) {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: setClientId.isPending ? "Saving…" : "Save"
        }
      )
    ] }),
    isSet && !value && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "A Client ID is currently saved. Enter a new value above to replace it." }),
    setClientId.isError && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
...
function XConnectionSection() {
  ...
  const handleConnect = async () => {
    if (!clientId) {
      ue.error("Please save your X Client ID first");
      return;
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    !clientId && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
