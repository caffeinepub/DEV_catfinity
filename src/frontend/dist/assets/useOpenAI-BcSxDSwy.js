...
import { m as Subscribable, s as shallowEqualObjects, n as hashKey, o as getDefaultState, p as notifyManager, e as useQueryClient, r as reactExports, q as noop, t as shouldThrowError, c as createLucideIcon, j as jsxRuntimeExports, v as Slot, a as cn, w as cva } from "./index-CiYHczzU.js";
...
function useGetQAHistory(lessonId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["qaHistory", lessonId],
    queryFn: async () => {
      if (!actor) return [];
      return actor.getQAHistory(lessonId);
    },
    enabled: !!actor && !isFetching
  });
}
